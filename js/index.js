    ...
    series: [
      {
        ...
        type: "bar",
        barWidth: "35%",
        data: [350, 450, 700, 900, 1500, 1200, 600],
        itemStyle: {
          //修改柱形圆角
          barBorderRadius: 4,
        },
    ...
    yAxis: [
      {
        type: "category",
        inverse: true,
        data: ["HTML5", "CSS3", "javaScript", "VUE", "NODE", "TypeScript"],
        axisLabel: {
          color: "#fff",
        },
        // 不显示y轴线
...
//折线图2-播放量
(function () {
  let myChart = echarts.init(document.querySelector(".bar5 .chart"));
  let option = {
    tooltip: {
      trigger: "axis",
    },
    ...
    series: [
      ...
      },
      {
        ...
        itemStyle: {
          color: "#00d887",
          borderColor: "rgba(255,255,107,0.1)",
          borderWidth: 12,
        },
        //开始不显示拐点，鼠标经过显示
        showSymbol: false,
...
//饼形图2-地区分布
(function () {
  let myChart = echarts.init(document.querySelector(".bar6 .chart"));
  let option = {
    color: [
      "#006cff",
      "#60cda0",
